            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, minmax(0,1fr))', gap: 10, marginBottom: 16 }}>
              {weeklyJobColumns.map((day, dayIdx) => (
                <div key={day.label} style={{ background: '#1f1f1f', border: '1px solid #343434', borderRadius: 12, padding: 10, minHeight: 190 }}>
                  ...
                  {day.jobs.length === 0 ? (
                    <div style={{ fontSize: 12, color: '#9ca3af' }}>Keine Jobs</div>
                  ) : (
                ...
                >
                  ...
                  <div style={{ marginTop: 10, fontSize: 12, opacity: 0.82 }}>
                    {selectedCronJob.job.lastRunSummary && (
                      <div style={{ marginTop: 6, padding: 12, borderRadius: 10, border: '1px solid #2f2f2f', background: '#1b1b1b', color: '#e5e7eb' }}>
